    ...
    const loadLeagues = async () => {
      ...
      try {
        ...
        const leaguePromises = membersSnap.docs.map(async (memberDoc) => {
          ...
          const role =
            (memberDoc.data().role as "manager" | "member") || "member";
    ...
    <main className="min-h-screen bg-black text-white">
      <section className="max-w-6xl mx-auto px-4 py-8 md:py-10 space-y-6">
        ...
        <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-white/70 max-w-2xl">
              Play STREAKr with your mates, work crew or fantasy league. Create
              a private league, invite friends with a code, and battle it out on
              your own ladder while still counting towards the global Streak
              leaderboard.
            </p>
          </div>
        </header>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {/* Create a league */}
          <div className="rounded-2xl bg-black/80 border border-white/10 p-5 flex flex-col justify-between shadow-[0_0_40px_rgba(0,0,0,0.6)]">
            <div>
          ...
          {/* My leagues */}
          <div className="rounded-2xl bg-black/80 border border-white/10 p-5 flex flex-col shadow-[0_0_40px_rgba(0,0,0,0.6)]">
            ...
            {user && !loading && !error && leagues.length > 0 && (
              <div className="space-y-3">
                ...
                {selectedLeague && (
                  <div className="mt-2 rounded-xl bg-black/60 border border-white/10 px-3 py-3 space-y-2 text-xs">
