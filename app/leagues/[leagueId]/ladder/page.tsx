  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-6 md:py-8 space-y-6">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <Link
          href="/picks"
          className="hidden sm:inline-flex items-center justify-center rounded-full bg-orange-500 hover:bg-orange-400 text-black font-semibold text-sm px-4 py-2 transition-colors shrink-0"
        >
          Make picks →
        </Link>
      </div>
      ...
      {myRow && (
        <div className="rounded-2xl border border-orange-500/25 bg-orange-500/10 p-4 md:p-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <Link
              href="/picks"
              className="sm:hidden inline-flex items-center justify-center rounded-full bg-orange-500 hover:bg-orange-400 text-black font-semibold text-sm px-4 py-2 transition-colors"
            >
              Make picks →
            </Link>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-10 text-white/80 font-semibold">
                      #{rank} {showCrown ? "👑" : ""}
                    </div>
