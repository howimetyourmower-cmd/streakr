...
function Dot() {
  return <span className="inline-block h-1.5 w-1.5 rounded-full" style={{ backgroundColor: COLORS.red }} />;
}
...
function CheckIcon({ accent }: { accent?: boolean }) {
  const stroke = accent ? COLORS.red : "rgba(255,255,255,0.85)";
  const bg = accent ? `${COLORS.red}1A` : "rgba(255,255,255,0.08)";
  return (
...
const PREMIUM_TEASE = [
  "Unlock all 15 questions per game",
  "Last 5 games stats per question",
  "Live YES/NO percentages + simple trends",
...
export default function ScreamrPreviewPage() {
  ...
  const noBtnStyle = {
    ...
    background: `linear-gradient(180deg, ${rgbaFromHex(COLORS.red, 0.98)}, ${rgbaFromHex(COLORS.redDeep, 0.92)})`,
    color: "rgba(255,255,255,0.98)",
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-black text-white/80">
                  <Dot />
            ...
            <div className="hidden lg:flex flex-1 justify-end">
              <div className="rounded-3xl border p-5" style={{ ...glassCardStyle, width: 380, animation: "floaty 4.2s ease-in-out infinite" }}>
                ...
                <div className="mt-5 rounded-2xl border p-4" style={{ borderColor: "rgba(255,255,255,0.10)", background: "rgba(0,0,0,0.22)" }}>
                  ...
                  <div className="mt-2 text-[13px] font-black" style={{ color: COLORS.red }}>
                    Free Kick
                  </div>
                  <div className="mt-1 text-[12px] text-white/70 leading-relaxed">
                    If you lose a streak, Free Kick rolls you back to the previous total. Powerful — not pay-to-win.
                  </div>
                </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {isLockedTease ? (
                              <div className="mt-3 flex flex-wrap items-center gap-2">
                                <Pill>Premium preview</Pill>
                                <Pill>Stats + live %</Pill>
                                <Pill>Free Kick</Pill>
                              </div>
                            ) : null}
                          </div>
                          ...
                          <div className="flex items-center gap-3 lg:ml-6 shrink-0">
                            {isLockedTease ? (
                              <>
                                <button
                                  type="button"
                                  onClick={() => openUpgrade("Unlock Premium to access more questions + stats")}
                                  ...
                                  style={{
                                    ...
                                    boxShadow: `0 0 18px ${rgbaFromHex(COLORS.red, 0.12)}`,
                                  }}
                                >
                                  UNLOCK
                                </button>
