      ...
      <div className="border-b border-slate-800 bg-gradient-to-r from-slate-950/80 via-slate-900/80 to-slate-950/80">
        <div className="mx-auto max-w-5xl px-4 py-8">
          ...
          <p className="text-sm md:text-base text-slate-400 max-w-2xl">
            Set up a STREAKr league for a pub, club or sports bar. Players
            still build the same streak as general play, but this venue gets
            its own leaderboard, prizes and promotions.
          </p>
        </div>
      </div>
