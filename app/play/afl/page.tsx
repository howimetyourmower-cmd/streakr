            ...
            <div className="rounded-3xl border border-white/10 bg-gradient-to-r from-white/5 via-[#020617] to-[#020617] p-4 sm:p-5 shadow-[0_18px_60px_rgba(0,0,0,0.85)]">
              <div className="flex items-center justify-between gap-3 mb-3">
                <div>
                  ...
                  <p className="text-[12px] text-white/70">3 steps. Fast picks. Big sweat.</p>
                </div>
                <Link
                  href={picksHref}
                  onClick={onClickGoToPicks}
              ...
              <div className="grid sm:grid-cols-3 gap-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#020617] px-4 py-4 hover:border-orange-400/40 transition">
                  ...
                  <p className="text-sm text-white/80">Beat your mates, climb leaderboards, win prizes, talk big.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-white/70">
                New player? Tap <span className="font-semibold">Yes</span> or{" "}
                <span className="font-semibold">No</span> to see exactly how it works.
              </p>
            </div>
